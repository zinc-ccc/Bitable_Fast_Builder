...
- **最佳实践【无需手写，全程让 AI 代劳】**：立项的第一天，请务必在你的项目根目录建一个 Markdown 格式的《项目操作手册.md》（请不要使用 .doc 格式）。**大家务必不要自己手写，这很浪费精力！这是 Agent 的核心工作**，你只需要指挥 Agent 自动为你生成大纲、整理逻辑并负责后续的持续更新即可。
